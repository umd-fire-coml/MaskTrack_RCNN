...
class WADDataset(utils.Dataset):
    ...
    def __init__(self, root_dir=None, random_state=42):
        ...
        ### OPTIMIZATION TESTING
        print('OPTIMIZATION LOG: __init__ time: ' + str(time.time() - start))
        ### OPTIMIZATION TESTING
    ...
    def load_video(self, video_list_filename, labeled=True, assume_match=False):
        ...
        ### OPTIMIZATION TESTING
        print('OPTIMIZATION LOG: load_video time: ' + str(time.time() - start))
        ### OPTIMIZATION TESTING
    ...
    def _load_all_images(self, labeled=True, assume_match=False, val_size=0):
        ...
        ### OPTIMIZATION TESTING
        print('OPTIMIZATION LOG: _load_all_images time: ' + str(time.time() - start))
        ### OPTIMIZATION TESTING
    ...
    def load_data(self, root_dir, subset, labeled=True, assume_match=False, val_size=0, use_pickle=True):
        ...
        if use_pickle and val_size == 0 and isfile(pickle_path):
            ...
            if val is not None:
                ...
                ### OPTIMIZATION TESTING
                print('OPTIMIZATION LOG: load_data time: ' + str(time.time() - start))
                ### OPTIMIZATION TESTING
    ...
    def load_image(self, image_id):
        ...
        ### OPTIMIZATION TESTING
        print('OPTIMIZATION LOG: load_image time: ' + str(time.time() - start))
        ### OPTIMIZATION TESTING
    ...
    def load_mask(self, image_id):
        ...
        ### OPTIMIZATION TESTING
        print('OPTIMIZATION LOG: load_mask time: ' + str(time.time() - start))
        ### OPTIMIZATION TESTING
    ...
    def load_data_from_file(self, filename):
        ...
        ### OPTIMIZATION TESTING
        print('OPTIMIZATION LOG: load_data_from_file time: ' + str(time.time() - start))
        ### OPTIMIZATION TESTING
    ...
    def save_data_to_file(self, filename):
        ...
        ### OPTIMIZATION TESTING
        print('OPTIMIZATION LOG: save_data_to_file time: ' + str(time.time() - start))
        ### OPTIMIZATION TESTING
    ...
    def image_reference(self, image_id):
        ...
        ### OPTIMIZATION TESTING
        print('OPTIMIZATION LOG: image_reference time: ' + str(time.time() - start))
        ### OPTIMIZATION TESTING
