...
# IF YOU NEED TO STOP, WAIT TILL EPOCH FINISHES AND NEXT ONE BEGINS BEFORE CLOSING
...
import sys
sys.path.append("../MaskTrack_RCNN/pwc_net/pytorch")
sys.path.append("../")

from davis_wrapper_new import DavisDataset
from pwc_net_wrapper import PWCNetWrapper
